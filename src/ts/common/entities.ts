...
function decalOffset(name: string, sprite: PaletteRenderable, dx: number, dy: number, palette = 0, ...other: MixinEntity[]) {
	return registerMix(name, mixDraw(sprite, dx, dy, palette), mixFlags(EntityFlags.Decal), ...other);
}
...
export const triggerDoor = registerMix(n('trigger-door'), mixTrigger(-32, -6, 64, 12, true));

export const triggerHouseDoor = registerMix(n('trigger-house-door'), mixTrigger(-32, -6, 64, 12, false));

export const triggerBoat = registerMix(n('trigger-boat'), mixTrigger(-50, -12, 100, 24, false));

export const trigger3x1 = registerMix(n('trigger-3x1'), mixTrigger(-48, 0, 96, 24, true));

// house

export const house = doodad(
	n('house'),
	sprites.house,
	79,
	186,
...
export const window1 = registerMix(n('window-1'), mixDrawWindow(sprites.window_1, 21, 53, 0, 3, 0, 3, 1), mixOrder(1));
...
export const bookshelf = doodad(n('bookshelf'), sprites.bookshelf, 28, 81, 0, mixColliderRect(-32, -14, 66, 15));
...
export const boat = doodad(n('boat'), sprites.boat, 95, 4, 0, boatMinimap, mixOrder(-1));

export const boatBob = doodad(
	n('boat-bob'),
	sprites.boat,
	95,
	18,
...
export const boatFrontBob = doodad(
	n('boat-front-bob'),
	sprites.boat_front,
	71,
	16,
...
export const boatSail = doodad(n('boat-sail'), sprites.boat_sail, 77, 173, 0, mixCover(-8, -130, 70, 116), boatSailCollider);

export const rope = doodad(n('rope'), sprites.boat_rope, 5, 19, 0, mixPickable(31, 58));

export const ropeRack = doodad(
	n('rope-rack'),
	sprites.rope_rack,
	11,
	34,
...
export const boatRopeBob = doodad(n('boat-rope-bob'), sprites.boat_rope, 5, 19, 0, waterBobbing, mixFlags(EntityFlags.StaticY));

export const boatWake = registerMix(
	n('boat-wake'),
...
export function fullBoat(x: number, y: number, sail = true) {
	const sailEntities = sail
		? [boatSail(x - 12 / tileWidth, y + 16 / tileHeight), boatRopeBob(x - 91 / tileWidth, y + 8 / tileHeight)]
		: [];

	return [boatBob(x, y), boatFrontBob(x, y + 29 / tileHeight), ...sailEntities, boatWake(x, y + 5 / tileHeight)];
}

// pier

export const pierLeg = registerMix(
	n('pier-leg'),
...
export const plankShadow = registerMix(
	n('plank-shadow'),
...
export const plankShadow2 = registerMix(
	n('plank-shadow-2'),
...
export const plankShadowShort = registerMix(
	n('plank-shadow-short'),
...
export const cookieTable = doodad(
	n('cookie-table'),
	sprites.cookie_table_1,
	13,
	28,
	0,
...
export const cookieTable2 = doodad(
	n('cookie-table-2'),
	sprites.cookie_table_2,
	13,
	28,
	0,
	mixFlags(EntityFlags.Interactive),
...
export const letter = doodad(n('letter'), sprites.letter, 4, 10, 0, mixPickable(30, 50));

export const rose = doodad(n('rose'), sprites.rose, 8, 1, 0, mixPickable(30, 41));

// tools

export const hammer = doodad(n('hammer'), sprites.hammer, 8, 10, 0, mixPickable(25, 46), mixFlags(EntityFlags.Usable));

export const shovel = doodad(n('shovel'), sprites.shovel, 16, 6, 0, mixPickable(29, 42), mixFlags(EntityFlags.Usable));

export const rake = doodad(n('rake'), sprites.rake, 16, 6, 0, mixPickable(30, 42));

export const pickaxe = doodad(n('pickaxe'), sprites.pickaxe, 10, 8, 0, mixPickable(28, 42));

export const broom = doodad(n('broom'), sprites.broom, 16, 6, 0, mixPickable(27, 42));

export const saw = doodad(n('saw'), sprites.saw, 10, 7, 0, mixPickable(26, 47));
...
export const jackoLanternOff = collectable(
	n('jacko-lantern-off'),
	sprites.jacko_lantern_off,
	0,
	jackoLanternPickable,
	jackLanternCollider,
);

export const jackoLanternOn = collectable(
	n('jacko-lantern-on'),
	sprites.jacko_lantern_on,
	0,
	jackoLanternPickable,
	jackLanternCollider,
...
export const lanternOn = registerMix(
	n('lantern-on'),
...
export const lanternOnWall = registerMix(
	n('lantern-on-wall'),
	mixAnimation(sprites.lantern, 12, 4, 13 + 24, { lightSprite: lanternLightSprite }),
	mixLight(0x916a32ff, 0, 0, 384, 288),
);

export const lanternOnTable = registerMix(
	n('lantern-on-table'),
	mixAnimation(sprites.lantern, 12, 4, 13 + 14, { lightSprite: lanternLightSprite }),
	mixLight(0x916a32ff, 0, 0, 384, 288),
);

export const candy = doodad(n('candy'), sprites.candy, 4, 2, 0, mixInteract(-6, -6, 13, 13, 1.5));
...
export const signDebug = doodad(n('sign-debug'), sprites.sign_4, 12, 24, 0, ...signParts, mixFlags(EntityFlags.Debug));
...
export const directionSign = registerMix(
	n('direction-sign'),
	mixDrawDirectionSign(),
...
export const directionSignLefts = times(5, i => registerMix(n(`direction-sign-left-${i}`), mixBounds(-10, -59 + i * 11, 14, 10)));

export const directionSignRights = times(5, i =>
	registerMix(n(`direction-sign-right-${i}`), mixBounds(-4, -59 + i * 11, 14, 10)),
);

export const directionSignUpsLeft = times(5, i =>
	registerMix(n(`direction-sign-up-left-${i}`), mixBounds(-6, -70 + i * 12, 6, 11)),
);

export const directionSignUpsRight = times(5, i =>
	registerMix(n(`direction-sign-up-right-${i}`), mixBounds(1, -70 + i * 12, 5, 11)),
);

export const directionSignDownsLeft = times(5, i =>
	registerMix(n(`direction-sign-down-left-${i}`), mixBounds(-6, -57 + i * 13, 7, 12)),
);

export const directionSignDownsRight = times(5, i =>
	registerMix(n(`direction-sign-down-right-${i}`), mixBounds(0, -57 + i * 13, 5, 12)),
);
...
export const box = doodad(n('box'), sprites.box_empty, 16, 32, 0, ...boxParts);

export const boxLanterns = doodad(
	n('box-lanterns'),
...
export const boxBaskets = doodad(n('box-baskets'), sprites.box_baskets, 16, 32, 0, ...boxParts);

export const boxFruits = doodad(
	n('box-fruits'),
	sprites.box_fruits,
	16,
	32,
...
export const boxGifts = doodad(n('box-gifts'), sprites.box_gifts, 16, 32, 0, boxCollider, boxInteractiveClose, boxPickable);

const toolboxParts = [mixColliderRect(-15, -10, 30, 10), mixInteractAt(5), mixPickable(31, 60)];

export const toolboxEmpty = doodad(n('toolbox-empty'), sprites.toolbox_empty, 16, 22, 0, ...toolboxParts);
export const toolboxFull = doodad(
	n('toolbox-full'),
	sprites.toolbox_full,
	16,
	22,
	0,
	...toolboxParts,
...
export const rock = doodad(n('rock'), sprites.rock_1, 15, 20, 0, mixColliderRounded(-16, -12, 32, 12, 3, false), rockMinimap);

export const rock2 = doodad(n('rock-2'), sprites.rock_2, 11, 11, 0, mixColliderRounded(-10, -4, 17, 5, 2, false), rockMinimap);

export const rock3 = doodad(n('rock-3'), sprites.rock_3, 10, 11, 0, mixColliderRounded(-10, -4, 18, 5, 2, false), rockMinimap);

export const rockB = doodad(n('rockb'), sprites.rock_1, 15, 20, 1, mixColliderRounded(-16, -12, 32, 12, 3, false), rockMinimap);

export const rock2B = doodad(n('rock-2b'), sprites.rock_2, 11, 11, 1, mixColliderRounded(-10, -4, 17, 5, 2, false), rockMinimap);

export const rock3B = doodad(n('rock-3b'), sprites.rock_3, 10, 11, 1, mixColliderRounded(-10, -4, 18, 5, 2, false), rockMinimap);

// other

export const well = doodad(n('well'), sprites.well, 30, 67, 0, mixColliderRect(-26, -20, 54, 30));

// water rocks

const waterRockFPS = WATER_FPS;

export const waterRock1 = registerMix(
	n('water-rock-1'),
...
export const waterRock2 = registerMix(
	n('water-rock-2'),
...
export const waterRock3 = registerMix(
	n('water-rock-3'),
...
export const waterRock4 = registerMix(
	n('water-rock-4'),
...
export const waterRock5 = registerMix(
	n('water-rock-5'),
...
export const waterRock6 = registerMix(
	n('water-rock-6'),
...
export const waterRock7 = registerMix(
	n('water-rock-7'),
...
export const waterRock8 = registerMix(
	n('water-rock-8'),
...
export const waterRock9 = registerMix(
	n('water-rock-9'),
...
export const waterRock10 = registerMix(
	n('water-rock-10'),
...
export const waterRock11 = registerMix(
	n('water-rock-11'),
...
export const stoneWallFull = doodad(n('stone-wall-full'), sprites.stone_wall_full, 38, 22, 0, mixColliderRect(-38, -4, 76, 6));

// stone wall

const stoneWallMinimapColor = 0x9b9977ff;

export const stoneWallPole1 = registerMix(
	n('stone-wall-pole-1'),
	mixDrawSeasonal({
...
export const stoneWallBeamH1 = registerMix(
	n('stone-wall-beam-h-1'),
	mixDrawSeasonal({
...
export const stoneWallBeamV1 = registerMix(
	n('stone-wall-beam-v-1'),
	mixDrawSeasonal({
...
export const woodenFencePole1 = woodenFencePole(
	n('wooden-fence-pole-1'),
	sprites.wooden_fence_pole1,
	sprites.wooden_fence_winter_pole1,
);
export const woodenFencePole2 = woodenFencePole(
	n('wooden-fence-pole-2'),
	sprites.wooden_fence_pole2,
	sprites.wooden_fence_winter_pole2,
);
export const woodenFencePole3 = woodenFencePole(
	n('wooden-fence-pole-3'),
	sprites.wooden_fence_pole3,
	sprites.wooden_fence_winter_pole3,
);
export const woodenFencePole4 = woodenFencePole(
	n('wooden-fence-pole-4'),
	sprites.wooden_fence_pole4,
	sprites.wooden_fence_winter_pole4,
);
export const woodenFencePole5 = woodenFencePole(
	n('wooden-fence-pole-5'),
	sprites.wooden_fence_pole5,
	sprites.wooden_fence_winter_pole5,
);

export const woodenFenceBeamH1 = woodenFenceBeamH(
	n('wooden-fence-beam-h-1'),
	sprites.wooden_fence_horizontal1,
	sprites.wooden_fence_winter_horizontal1,
);
export const woodenFenceBeamH2 = woodenFenceBeamH(
	n('wooden-fence-beam-h-2'),
	sprites.wooden_fence_horizontal2,
	sprites.wooden_fence_winter_horizontal2,
);
export const woodenFenceBeamH3 = woodenFenceBeamH(
	n('wooden-fence-beam-h-3'),
	sprites.wooden_fence_horizontal3,
	sprites.wooden_fence_winter_horizontal3,
);
export const woodenFenceBeamH4 = woodenFenceBeamH(
	n('wooden-fence-beam-h-4'),
	sprites.wooden_fence_horizontal4,
	sprites.wooden_fence_winter_horizontal4,
);
export const woodenFenceBeamH5 = woodenFenceBeamH(
	n('wooden-fence-beam-h-5'),
	sprites.wooden_fence_horizontal5,
	sprites.wooden_fence_winter_horizontal5,
);
export const woodenFenceBeamH6 = woodenFenceBeamH(
	n('wooden-fence-beam-h-6'),
	sprites.wooden_fence_horizontal6,
	sprites.wooden_fence_winter_horizontal6,
);

export const woodenFenceBeamV1 = woodenFenceBeamV(
	n('wooden-fence-beam-v-1'),
	sprites.wooden_fence_vertical1,
	sprites.wooden_fence_winter_vertical1,
);
export const woodenFenceBeamV2 = woodenFenceBeamV(
	n('wooden-fence-beam-v-2'),
	sprites.wooden_fence_vertical2,
	sprites.wooden_fence_winter_vertical2,
);
export const woodenFenceBeamV3 = woodenFenceBeamV(
	n('wooden-fence-beam-v-3'),
	sprites.wooden_fence_vertical3,
	sprites.wooden_fence_winter_vertical3,
);

// fence

export const fence1 = registerMix(
	n('fence-1'),
	mixDrawSeasonal({
...
export const fence2 = registerMix(
	n('fence-2'),
	mixDrawSeasonal({
...
export const fence3 = registerMix(
	n('fence-3'),
	mixDrawSeasonal({
...
export const rain = registerMix(n('rain'), mixAnimation(sprites.rain, 12, 16, 512, { color: rainColor }));

export const raindrop = registerMix(n('raindrop'), mixAnimation(sprites.raindrop, 12, 4, 0, { color: rainColor }));
...
export const flower3Pickable = decal(n('flower-3-pickable'), sprites.flower_3, 0, mixInteract(-7, -3, 15, 15, 1.5));

export const flowerPick = decal(n('flower-pick'), sprites.flower_pick, 0, mixPickable(31, 39));
...
export const fourLeafClover = decal(n('four-leaf-clover'), sprites.clover_4, 0, mixInteract(-7, -3, 15, 15, 1.5));
...
export const cloverPick = doodad(n('clover-pick'), sprites.clover_mouth, 5, 0, 0, mixPickable(29, 39));

export const cloverPick2 = doodad(n('clover-pick-2'), sprites.clover_pick, 5, 0, 0, mixPickable(31, 39));
...
export const [leafpileSmallYellow, leafpileSmallOrange, leafpileSmallRed] = doodadSet(
	n('leafpile-small'),
	sprites.leafpile_small,
	18,
	16,
	smallLeafPileCollider,
);

export const [leafpileStickYellow, leafpileStickOrange, leafpileStickRed] = doodadSet(
	n('leafpile-stick'),
	sprites.leafpile_stick,
	18,
	16,
	smallLeafPileCollider,
);

export const [leafpileMediumYellow, leafpileMediumOrange, leafpileMediumRed] = doodadSet(
	n('leafpile-medium'),
	sprites.leafpile_medium,
	35,
	23,
	mediumLeafPileCollider,
);

export const [leafpileMediumAltYellow, leafpileMediumAltOrange, leafpileMediumAltRed] = doodadSet(
	n('leafpile-mediumalt'),
	sprites.leafpile_mediumalt,
	35,
	23,
	mediumLeafPileCollider,
);

export const [leafpileBigYellow, leafpileBigOrange, leafpileBigRed] = doodadSet(
	n('leafpile-big'),
	sprites.leafpile_big,
	43,
	34,
	bigLeafPileCollider,
);

export const [leafpileBigstickYellow, leafpileBigstickOrange, leafpileBigstickRed] = doodadSet(
	n('leafpile-bigstick'),
	sprites.leafpile_bigstick,
	43,
	34,
	bigLeafPileCollider,
);
...
export const gift3 = doodad(n('gift-3'), sprites.gift_2, giftOffsetX, giftOffsetY, 1, giftInteractive, giftPickable);

// gift piles

export const giftPileSign = doodad(n('giftpile-sign'), sprites.giftpile_sign, 47, 39, 0, mixColliderRounded(-44, -21, 89, 55, 7));
export const giftPileTree = doodad(n('giftpile-tree'), sprites.giftpile_tree, 42, 21, 0, mixColliderRounded(-41, -12, 83, 28, 7));
export const giftPilePine = doodad(
	n('giftpile-pine'),
	sprites.giftpile_pine,
	56,
	24,
	0,
...
export const giftPileInteractive = doodad(
	n('giftpile-5-interactive'),
	sprites.giftpile_5,
	20,
	20,
	0,
...
export const snowponies = [snowpony1, snowpony2, snowpony3, snowpony4, snowpony5, snowpony6, snowpony7, snowpony8, snowpony9];
...
export const snowPileSmall = doodad(
	n('snowpile-small'),
	sprites.snowpile_small,
	22,
	15,
	0,
	mixColliderRounded(-15, -4, 31, 7, 2, false),
);
export const snowPileMedium = doodad(
	n('snowpile-medium'),
	sprites.snowpile_medium,
	33,
	20,
	0,
	mixColliderRounded(-23, -4, 46, 12, 4, false),
);
export const snowPileBig = doodad(
	n('snowpile-big'),
	sprites.snowpile_big,
	43,
	28,
	0,
...
export const sandPileSmall = doodad(
	n('sandpile-small'),
	sprites.snowpile_small,
	22,
	15,
...
export const sandPileMedium = doodad(
	n('sandpile-medium'),
	sprites.snowpile_medium,
	33,
	20,
...
export const sandPileBig = doodad(
	n('sandpile-big'),
	sprites.snowpile_big,
	43,
	28,
...
export const pumpkin = doodad(n('pumpkin'), sprites.pumpkin_default, pumpkinDX, pumpkinDY, 0, ...pumpkinParts);

export const jackoOff = doodad(n('jacko-off'), sprites.pumpkin_off, pumpkinDX, pumpkinDY, 0, ...pumpkinParts);

export const jackoOn = doodad(
	n('jacko-on'),
	sprites.pumpkin_on,
	pumpkinDX,
	pumpkinDY,
...
export const tombstone1 = doodad(n('tombstone-1'), sprites.tombstone_1, 14, 18, 0, mixColliderRect(-14, -4, 29, 9));

export const tombstone2 = doodad(n('tombstone-2'), sprites.tombstone_2, 11, 27, 0, mixColliderRect(-12, -3, 26, 6));
...
export const torchOff = doodad(n('torch-off'), torchUnlitSprite, torchDX, torchDY, 0, torchCollider);

export const torchOn = registerMix(
	n('torch-on'),
	mixAnimation(torchSpriteOn, 8, torchDX, torchDY, { lightSprite: torchLightSpriteOn }),
	torchCollider,
	mixLight(0x926923ff, 0, 0, 440, 332),
); // 0x924d23ff 0x917b32ff

export const torch = registerMix(
	n('torch'),
...
export const poof2 = registerMix(
	n('poof-2'),
	mixAnimation(
		{
...
export const splash = registerMix(
	n('splash'),
	mixAnimation(
		{
...
const boopSplashFrames = [...repeat(3, sprites.emptySprite2), ...sprites.splash_boop.frames, sprites.emptySprite2];

const boopSlashFps = 20;
const boopSlashDX = 11;
const boopSlashDY = 55;

export const boopSplashRight = registerMix(
	n('boop-splash-right'),
	mixAnimation(
		{
...
export const boopSplashLeft = registerMix(
	n('boop-splash-left'),
	mixAnimation(
		{
			frames: boopSplashFrames,
...
export const bat = registerMix(
	n('bat'),
	mixAnimation(sprites.bat, 8, 10, 65),
	mixFlags(EntityFlags.Critter | EntityFlags.Movable | EntityFlags.StaticY),
);

export const spider = registerMix(
	n('spider'),
...
export const bunny = registerMix(
	n('bunny'),
...
const ghostSprite: AnimatedRenderable = {
	frames: [sprites.emptySprite2, ...sprites.ghost1.frames],
	palette: sprites.ghost1.palette,
};

const ghostHoovesSprite: AnimatedRenderable = {
	frames: [sprites.emptySprite2, ...sprites.ghost1_hooves.frames, ...repeat(17, sprites.emptySprite2)],
	palette: sprites.ghost1_hooves.palette,
};

const ghostLightSprite: AnimatedRenderable1 = {
	frames: [sprites.emptySprite, ...sprites.ghost1_light.frames],
};

const ghostHoovesLightSprite: AnimatedRenderable1 = {
	frames: [sprites.emptySprite, ...sprites.ghost1_hooves_light.frames],
};
...
export const cloud = registerMix(
	n('cloud'),
...
export const largeLeafedBush1 = registerMix(
	n('large-leafed-bush-1'),
	mixDrawSeasonal({
...
export const largeLeafedBush2 = registerMix(
	n('large-leafed-bush-2'),
	mixDrawSeasonal({
...
export const largeLeafedBush3 = registerMix(
	n('large-leafed-bush-3'),
	mixDrawSeasonal({
...
export const largeLeafedBush4 = registerMix(
	n('large-leafed-bush-4'),
	mixDrawSeasonal({
...
function cliff(name: string, sprite: PaletteRenderable, ...other: MixinEntity[]) {
	return cliffOffset(
		name,
		sprite,
		Math.floor((sprite.color!.w + sprite.color!.ox) / 2),
		sprite.color!.oy,
		mixFlags(EntityFlags.StaticY),
		...other,
	);
...
function cliffDecal(name: string, sprite: PaletteRenderable, dx: number, dy: number, ...other: MixinEntity[]) {
	return cliffOffset(name, sprite, dx, dy, mixFlags(EntityFlags.Decal), ...other);
}

export const cliffSW = cliff(
	n('cliff-sw'),
	sprites.cliffs_grass_sw,
	mixColliders(
...
export const cliffSE = cliff(
	n('cliff-se'),
	sprites.cliffs_grass_se,
	mixColliders(
...
export const cliffS1 = cliff(n('cliff-s1'), sprites.cliffs_grass_s1, cliffSCollider, mixMinimap(cliffColor, rect(-1, 0, 1, 3)));

export const cliffS2 = cliff(n('cliff-s2'), sprites.cliffs_grass_s2, cliffSCollider, mixMinimap(cliffColor, rect(-1, 0, 1, 3)));

export const cliffS3 = cliff(n('cliff-s3'), sprites.cliffs_grass_s3, cliffSCollider, mixMinimap(cliffColor, rect(-1, 0, 1, 3)));

export const cliffSb = cliff(n('cliff-sb'), sprites.cliffs_grass_sb, cliffSCollider, mixMinimap(cliffColor, rect(-1, 0, 1, 3)));

export const cliffSbEntrance = cliff(
	n('cliff-sb-entrance'),
	sprites.cliffs_grass_sb,
...
const cliffColliderTrimRightBot = mixColliders(collider(0, 0, 16, 17, cliffTall), ...taperColliderNE(0, 17, 16, 11, cliffTall));
...
export const cliffTopTrimLeft = cliffDecal(
	n('cliff-top-trim-left'),
	sprites.cliffs_grass_top_trim_left,
	16,
	0,
	cliffColliderTrimRight,
	mixOrder(1),
);
export const cliffMidTrimLeft = cliffDecal(
	n('cliff-mid-trim-left'),
	sprites.cliffs_grass_mid_trim_left,
	16,
	0,
	cliffColliderTrimRight,
	mixOrder(1),
...
export const cliffBotTrimLeft = cliffDecal(
	n('cliff-bot-trim-left'),
	sprites.cliffs_grass_bot_trim_left,
	16,
	0,
	cliffColliderTrimRightBot,
	mixOrder(1),
);

export const cliffTopTrimRight = cliffDecal(
	n('cliff-top-trim-right'),
	sprites.cliffs_grass_top_trim_right,
	16,
	0,
	cliffColliderTrimLeft,
);
export const cliffMidTrimRight = cliffDecal(
	n('cliff-mid-trim-right'),
	sprites.cliffs_grass_mid_trim_right,
	16,
	0,
	cliffColliderTrimLeft,
);
export const cliffBotTrimRight = cliffDecal(
	n('cliff-bot-trim-right'),
	sprites.cliffs_grass_bot_trim_right,
	16,
	0,
	cliffColliderTrimLeftBot,
);
...
function caveDecal(name: string, sprite: PaletteRenderable, dx: number, dy: number, ...other: MixinEntity[]) {
	return caveOffset(name, sprite, dx, dy, mixFlags(EntityFlags.Decal), ...other);
}

export const caveSW = cave(
	n('cave-sw'),
	sprites.cave_walls_sw,
	mixColliders(collider(-16, -3, 35, 24 * 2 + 7 + 25, caveTall), ...taperColliderNE(-16, 22 + 24 * 2 + 7, 32, 24, caveTall)),
	mixMinimap(caveColor, rect(-1, 0, 1, 4)),
);

export const caveSE = cave(
	n('cave-se'),
	sprites.cave_walls_se,
	mixColliders(collider(-19, -3, 35, 24 * 2 + 7 + 25, caveTall), ...taperColliderNW(-16, 22 + 24 * 2 + 7, 32, 24, caveTall)),
	mixMinimap(caveColor, rect(-1, 0, 1, 4)),
);

const caveSCollider = mixColliderRect(-16, -3, 32, 24 * 3 + 8, caveTall);

export const caveS1 = cave(n('cave-s1'), sprites.cave_walls_s1, caveSCollider, mixMinimap(caveColor, rect(-1, 0, 1, 3)));

export const caveS2 = cave(n('cave-s2'), sprites.cave_walls_s2, caveSCollider, mixMinimap(caveColor, rect(-1, 0, 1, 3)));

export const caveS3 = cave(n('cave-s3'), sprites.cave_walls_s3, caveSCollider, mixMinimap(caveColor, rect(-1, 0, 1, 3)));

export const caveSb = cave(n('cave-sb'), sprites.cave_walls_sb, caveSCollider, mixMinimap(caveColor, rect(-1, 0, 1, 3)));
...
const caveColliderTrimLeftBot = mixColliders(collider(-16, 0, 16, 17, caveTall), ...taperColliderNW(-16, 17, 16, 11, caveTall));

const caveColliderTrimRightBot = mixColliders(collider(0, 0, 16, 17, caveTall), ...taperColliderNE(0, 17, 16, 11, caveTall));
...
export const caveTopTrimLeft = caveDecal(
	n('cave-top-trim-left'),
	sprites.cave_walls_top_trim_left,
	16,
	0,
	caveColliderTrimRight,
	mixOrder(1),
);
export const caveMidTrimLeft = caveDecal(
	n('cave-mid-trim-left'),
	sprites.cave_walls_mid_trim_left,
	16,
	0,
	caveColliderTrimRight,
	mixOrder(1),
...
export const caveBotTrimLeft = caveDecal(
	n('cave-bot-trim-left'),
	sprites.cave_walls_bot_trim_left,
	16,
	0,
	caveColliderTrimRightBot,
	mixOrder(1),
);

export const caveTopTrimRight = caveDecal(
	n('cave-top-trim-right'),
	sprites.cave_walls_top_trim_right,
	16,
	0,
	caveColliderTrimLeft,
);
export const caveMidTrimRight = caveDecal(
	n('cave-mid-trim-right'),
	sprites.cave_walls_mid_trim_right,
	16,
	0,
	caveColliderTrimLeft,
);
export const caveBotTrimRight = caveDecal(
	n('cave-bot-trim-right'),
	sprites.cave_walls_bot_trim_right,
	16,
	0,
	caveColliderTrimLeftBot,
);
...
export const caveFill = registerMix(
	n('cave-fill'),
...
export const caveCover = registerMix(n('cave-cover'), mixDraw(sprites.tile_none, 0, 24), mixFlags(EntityFlags.StaticY));

// stalactites

export const stalactite1 = doodad(
	n('stalactite-1'),
	sprites.stalactite_1,
	4,
	15,
	0,
...
export const stalactite2 = doodad(
	n('stalactite-2'),
	sprites.stalactite_2,
	5,
	31,
	0,
...
export const stalactite3 = doodad(
	n('stalactite-3'),
	sprites.stalactite_3,
	6,
	51,
	0,
...
export const crystals1 = registerMix(
	n('crystals-1'),
...
export const crystals2 = registerMix(
	n('crystals-2'),
...
export const crystals3 = registerMix(
	n('crystals-3'),
...
export const crystals4 = registerMix(
	n('crystals-4'),
...
export const crystals5 = registerMix(
	n('crystals-5'),
...
export const crystals6 = registerMix(
	n('crystals-6'),
...
export const crystals7 = registerMix(
	n('crystals-7'),
...
export const crystals8 = registerMix(
	n('crystals-8'),
...
export const crystals9 = registerMix(
	n('crystals-9'),
...
export const crystals10 = registerMix(
	n('crystals-10'),
...
export const crystalsCartPile = registerMix(
	n('crystals-cart-pile'),
...
export const crystalHeld = registerMix(
	n('crystal-held'),
...
export const crystalLantern = registerMix(
	n('crystal-lantern'),
...
export const waterCrystal1 = registerMix(
	n('water-crystal-1'),
...
export const waterCrystal2 = registerMix(
	n('water-crystal-2'),
...
export const waterCrysta3 = registerMix(
	n('water-crystal-3'),
...
export const mineEntrance = registerMix(
	n('mine-entrance'),
...
export const mineClosed = registerMix(n('mine-closed'), mixDraw(sprites.mine_closed, 36, -24), mixOrder(11));

export const mineCart = doodad(
	n('mine-cart'),
	sprites.mine_cart,
	26,
	32,
...
export const mineCartFront = doodad(
	n('mine-cart-front'),
	sprites.mine_cart_front,
	26,
	52,
	0,
	mixColliders(collider(-30, -25, 55, 4), collider(-30, -19, 15, 20), collider(-30, 2, 55, 4)),
	mixFlags(EntityFlags.StaticY),
);

export const mineCartBack = doodad(n('mine-cart-back'), sprites.mine_cart_back, 26, 30, 0, mixFlags(EntityFlags.StaticY));
...
export const mineRailsEndLeft = doodad(
	n('mine-rails-end-left'),
	sprites.mine_rails_end_left,
	17,
	30,
	0,
...
export const mineRailsEndRight = doodad(
	n('mine-rails-end-right'),
	sprites.mine_rails_end_right,
	16,
	30,
	0,
...
export const mineRailsEndTop = doodad(
	n('mine-rails-end-top'),
	sprites.mine_rails_end_top,
	16,
	32,
	0,
...
export const mineRailsFadeUp = decal(n('mine-rails-fade-up'), sprites.mine_rail_fade_up, 0, railsExtra);
...
export const web = doodad(n('web'), sprites.web, -6, 39, 0, mixCover(-50, -135, 110, 120));
...
export const pine1 = registerMix(
	n('pine1'),
	mixDrawSeasonal({
...
export const pine2 = registerMix(
	n('pine2'),
	mixDrawSeasonal({
...
export const [pine3] = createTree(n('pine3'), 25, 68, 2, {
	...
	variants: [{ stump: sprites.pine_3Stump0, crown: sprites.pine_3Crown0_0, palette: 0, paletteAutumn: 1, paletteWinter: 2 }],
});
...
export const [pine4] = createTree(n('pine4'), 41, 95, 8, {
	...
	variants: [{ stump: sprites.pine_4Stump0, crown: sprites.pine_4Crown0_0, palette: 0, paletteAutumn: 1, paletteWinter: 2 }],
});
...
export const [pine5] = createTree(n('pine5'), 53, 136, 5, {
	...
	variants: [{ stump: sprites.pine_5Stump0, crown: sprites.pine_5Crown0_0, palette: 0, paletteAutumn: 1, paletteWinter: 2 }],
});
...
export const stashEntities = [rose, cookie, cookiePony, letter, rope];
