...
export const GAMEPAD_MAPPINGS: GamepadMapping[] = [
	gamepad(
		'Logitech F310 (DirectInput) Chrome/Firefox Linux',
		[
	...
	gamepad(
		'Logitech F310 (DirectInput) Chrome Windows/OSX',
		[
	...
	gamepad(
		'Logitech F310 (DirectInput) Firefox OSX',
	...
	gamepad(
		'Logitech F310 (DirectInput) Firefox Windows',
	...
	gamepad(
		'Logitech F310 (XInput) Chrome Linux',
	...
	gamepad(
		'Logitech F310 (XInput) Firefox Linux',
	...
	gamepad(
		'PLAYSTATION(R)3 Controller (STANDARD GAMEPAD Vendor: 054c Product: 0268) Chrome OSX Linux',
		[
	...
	gamepad(
		'054c-0268-Sony PLAYSTATION(R)3 Controller Firefox Linux',
