...
export const CHANGELOG: { version: string; changes: string[] }[] = [
	...
	{
		version: 'v0.51.1',
		changes: ['Fixed multiple issues with party maps', 'Fixed being able to permanently hide your own character'],
	},
	{
		version: 'v0.51.0',
		changes: [
	...
	{
		version: 'v0.46.6',
		changes: ['Reverted performance improvement leading to issues with sprite rendering on some browsers'],
	},
	{
		version: 'v0.46.5',
		changes: [
	...
	{
		version: 'v0.46.2',
		changes: ['Fixed items spawning on cliffs', 'Fixed issues with date of birth month list', 'Updated swear filters'],
	},
	{
		version: 'v0.46.1',
		changes: [
	...
	{
		version: 'v0.42.4',
		changes: ['Changed season to spring', 'Updated swear filters', 'Fixed some issues with account alerts'],
	},
	{
		version: 'v0.42.3',
		changes: [
	...
	{
		version: 'v0.42.2',
		changes: ['Fixed issue with game breaking in some cases when the connection is interrupted'],
	},
	{
		version: 'v0.42.1',
		changes: ['Fixed issues with color pickers on some mobile devices'],
	},
	{
		version: 'v0.42.0',
		changes: [
	...
	{
		version: 'v0.40.1',
		changes: ['Remove loading performance optimization due to Yandex browser bug'],
	},
	{
		version: 'v0.40.0',
		changes: [
	...
	{
		version: 'v0.39.3',
		changes: ['Fixed issues with sending long messages on Edge and Internet Explorer browsers'],
	},
	{
		version: 'v0.39.2',
		changes: [
	...
	{
		version: 'v0.38.0',
		changes: ['Added winter environment details', 'Changed season to winter', 'Fixed some performance issues'],
	},
	{
		version: 'v0.37.3',
		changes: ['Fixed issues with character selection list on mobile devices', 'Fixed issues with keyboard on mobile devices'],
	},
	{
		version: 'v0.37.2',
		changes: ['Fixed issues with character selection', 'Fixed issues when using mouse with more than 3 buttons'],
	},
	{
		version: 'v0.37.1',
		changes: [
	...
	{
		version: 'v0.36.1',
		changes: ['Updated facebook sign-in', 'Fixed some lighting issues', 'Improved lighting performance'],
	},
	{
		version: 'v0.36.0',
		changes: [
	...
	{
		version: 'v0.35.6',
		changes: ['Improved server performance', 'Improved network usage'],
	},
	{
		version: 'v0.35.5',
		changes: [
	...
	{
		version: 'v0.35.2',
		changes: ['Fixed performance issues when a lot of users are joining the server at the same time'],
	},
	{
		version: 'v0.35.1',
		changes: [
